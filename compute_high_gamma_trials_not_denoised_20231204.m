...
SESSION = 'intraop';
TASK = 'smsl'; 
ARTIFACT_CRIT = 'E'; %%% criteria E = 70-150hz high gamma
...
ft_file = ['fieldtrip/' 'sub-' SUBJECT '_ses-' SESSION '_task-' TASK '_ft-raw-filt-trial-ar-ref-' ARTIFACT_CRIT '.mat'];
load(ft_file);
...
% compute log-spaced frequencies between wav_freq_min and wav_freq_max
  ...
  fprintf('doing %s %s \n',SUBJECT,param.name{idx});
    ...
    D_avgpow_eltype{i_eltype} = multifreq_avg_power(cfg, D_hpf);
