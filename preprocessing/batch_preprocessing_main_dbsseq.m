...
for isub = 1:nsubs
    ...
    for iband = 1:nbands
        ...
        %%% hack to maintain compatibility w/ Triplet and backward compatibility:  ...
        ...
        param = bml_annot_read_tsv([PATH_DBSSEQ_CODE, filesep, 'P08_artifact_criteria_',paramcode,...
            ...
            param = param(1,:); 
            param.name{1} = 'all';
            param.electrode_type{1} = '*'; % include all elc types
        ...
        % Change mask from zero to nan and expand
